...
public class DoughnutView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(doughnutWidth);
        paint.setStyle(Paint.Style.STROKE);
        paint.setShader(new SweepGradient(width / 2, height / 2, new int[]{Color.GREEN, Color.YELLOW, Color.RED}, null));
        ...
        canvas.rotate(90, width / 2, height / 2);
        initPaint();
        paint.setColor(ColorUtils.getCurrentColor(currentValue / 360f, new int[]{Color.GREEN, Color.YELLOW, Color.RED}));
